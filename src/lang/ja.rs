...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "次のデバイス設定ページに進み、「インストール済みアプリ」から「RustDesk Input」を有効にしてください。"),
        ("android_new_connection_tip", "新しい操作リクエストが届きました。このデバイスを操作しようとしています。"),
        ...
        ("config_input", "リモートコンピューターをキーボードで操作するには、RustDesk に「入力監視」の権限を与える必要があります。"),
        ("config_microphone", "リモートコンピューターと通話するには、RustDesk に「オーディオ録音」の権限を与える必要があります。"),
        ...
        ("wait_accept_uac_tip", "リモートデスクトップユーザーが UAC ダイアログを許可するまでしばらくお待ちください。"),
        ...
        ("idd_not_support_under_win10_2004_tip", "間接ディスプレイドライバーには対応していません。Windows 10 バージョン 2004 以降が必要です。"),
